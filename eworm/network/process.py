...
def circuit_search(sim_config, save_dir, search_config=None, data_config=None, weight_config=None, simplify_connection=False):
    """generating circuit simulation result"""
    # default setting
    search_config = {
        "total_sample": 16,
    ...
    del_circuit = config2detailed(config, search_config['input_cell_names'], load_hoc=True, mode=mode, simplify_connection=simplify_connection)
